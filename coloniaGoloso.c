...
void unirColonias(char ** distribucionDeColonia){
	int seRealizoUnion = 0;
	int indice = 0;
	while((*distribucionDeColonia)[indice + 1] != '\0' && seRealizoUnion == 0){
		if((*distribucionDeColonia)[indice] == '1'){
			if((*distribucionDeColonia)[indice + 1] == '2'){
				seRealizoUnion = 1;
				(*distribucionDeColonia)[indice] = '3';
				indice = indice + 1;
			...
			if((*distribucionDeColonia)[indice + 1] == '3'){
				seRealizoUnion = 1;
				(*distribucionDeColonia)[indice] = '2';
				indice = indice + 1;
				while((*distribucionDeColonia)[indice + 1] != '\0'){
					(*distribucionDeColonia)[indice] = (*distribucionDeColonia)[indice + 1];
					indice = indice + 1;
		...
		if((*distribucionDeColonia)[indice] == '2'){
			if((*distribucionDeColonia)[indice + 1] == '1'){
				seRealizoUnion = 1;
				(*distribucionDeColonia)[indice] = '3';
				indice = indice + 1;
				while((*distribucionDeColonia)[indice + 1] != '\0'){
			...
			if((*distribucionDeColonia)[indice + 1] == '3'){
				seRealizoUnion = 1;
				(*distribucionDeColonia)[indice] = '1';
				indice = indice + 1;
				while((*distribucionDeColonia)[indice + 1] != '\0'){
					(*distribucionDeColonia)[indice] = (*distribucionDeColonia)[indice + 1];
					indice = indice + 1;
...
void algoritmoUnionRecursivo(char ** distribucionDeColonia, int * cantidadColonia1, int * cantidadColonia2, int * cantidadColonia3){
	...
	if(verificarSiEsSolucionFinal(cantidadColonia1, cantidadColonia2, cantidadColonia3) == 0){
		printf("3\n");
		unirColonias(distribucionDeColonia);
		printf("4\n");
		algoritmoUnionRecursivo(distribucionDeColonia, cantidadColonia1, cantidadColonia2, cantidadColonia3);
		printf("5\n");
	}
}
